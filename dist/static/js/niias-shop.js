  ...
  "/Users/evgenyzhernoklev/Projects/NIIAS-shop/src/static/js/parallax.js": [function (require, module, exports) {
    ...
    var Parallax = /*#__PURE__*/function () {
      ...
      _createClass(Parallax, [{
        ...
        key: "_initKartoriumPage",
        value: function _initKartoriumPage() {
          _lax["default"].addElements('.js-parallax-item[data-item="kartorium-1"]', {
            scrollY: {
              scale: [[300, 1300], [1, 3]],
              opacity: [[300, 1300], [1, 0]]
            }
          });

          _lax["default"].addElements('.js-parallax-item[data-item="kartorium-2"]', {
            scrollY: {
              scale: [[800, 1800], [3, 1]],
              opacity: [[800, 1800], [0, 1]],
              translateY: [[2100, 2400, 3000, 3500], ['0', '-100', '-100', '-screenHeight']]
            }
          });

          _lax["default"].addElements('.js-parallax-item[data-item="kartorium-4"]', {
            scrollY: {
              translateY: [[1900, 2400, 3000, 3500, 4000], ['screenHeight', 'elHeight*2', 'elHeight*2', '-screenHeight/2', '-screenHeight']]
            }
          });
        }
      }, {
