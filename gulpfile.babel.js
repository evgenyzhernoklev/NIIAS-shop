...
const argv = yargs.argv,
	...
	paths = {
		...
		styles: {
			src: "./src/static/css/niias-shop.scss",
			dist: "./dist/static/css/",
			watch: "./src/static/css/**/*.scss"
		},
		scripts: {
			src: "./src/static/js/niias-shop.js",
			dist: "./dist/static/js/",
			watch: "./src/static/js/**/*.js"
		},
		images: {
			src: [
				"./src/static/images/**/*.{jpg,jpeg,png,gif,svg}",
				// "!./src/static/images/svg/*.svg",
				"!./src/static/images/favicon.{jpg,jpeg,png,gif}"
			],
			dist: "./dist/static/images/",
			watch: "./src/static/images/**/*.{jpg,jpeg,png,gif,svg}"
		},
		webp: {
			src: "./src/static/images/**/*_webp.{jpg,jpeg,png}",
			dist: "./dist/static/images/",
			watch: "./src/static/images/**/*_webp.{jpg,jpeg,png}"
		},
		sprites: {
			src: "./src/static/images/svg/*.svg",
			dist: "./dist/static/images/sprites/",
		...
		favicons: {
			...
			dist: "./dist/static/images/favicons/",
		},
		server_config: {
			src: "./src/.htaccess",
			dist: "./dist/"
...
export const prod = gulp.series(cleanFiles,
	// smartGrid,
	serverConfig, views, styles, scripts, images, webpimages, favs, fonts);
